# UCSD FMP Research on MLLM's Embodied Simulation
...
## Main Experiments
Main experiment can be separated into a 2 main sections with each having sub components. Each data collection, normalziation, and study experiments is contained in its own folder and result analysis conducted in the same folder as well.
